...
$jumlahData = count(query("SELECT * FROM tb_barang"));
$jumlahHalaman = ceil($jumlahData / $jumlahDataPerHalaman);
$halamanAktif = ( isset($_GET["halaman"]) ) ? $_GET["halaman"] : 1;
$awalData = ( $jumlahDataPerHalaman * $halamanAktif ) - $jumlahDataPerHalaman;

$barang = query("SELECT * FROM tb_barang LIMIT $awalData, $jumlahDataPerHalaman");
      ...
      <table class="table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><a class="btn btn-outline-primary btn-sm" href="ubah.php?id=<?= $row["id"]; ?>" role="button">Ubah</a>
              <a class="btn btn-outline-danger btn-sm" href="hapus.php?id=<?= $row["id"]; ?>" 
