...
$pembelian = query("SELECT * FROM tb_pembelian JOIN tb_user ON tb_pembelian.id_pelanggan=tb_user.id");
  ...
  <div class="row">
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Lihat Pembelian</h1>
      ...
      <table class="table">
        <thead>
          <tr>
            ...
            <th scope="col">Total Pembelian (Rp)</th>
            <th scope="col">Action</th>
          </tr>
        </thead>
        <tbody>
          <!--< $ambil = $koneksi->query("SELECT * FROM tb_pembelian JOIN tb_user ON tb_pembelian.id=tb_user.id_pelanggan"); ?>
          ...
          <tr>
            ...
            <td><a class="btn btn-outline-primary btn-sm" href="" role="button">Details</a></td>
          </tr>
          <?php $i++; ?>
          <?php endforeach; ?>
